...
class skillController extends Controller
{
    ...
    public function update(Request $request){
        if($request->method()=='POST'){
            ...
            ,
                '_worfklow.required' => 'Silahkan masukkan workflow yang kamu kuasai'
            ]);
            metadata::updateOrCreate(['meta_key'=>'language'],['meta_value'=>$request->_language]);
            metadata::updateOrCreate(['meta_key'=>'workflow'],['meta_value'=>$request->_workflow]);
