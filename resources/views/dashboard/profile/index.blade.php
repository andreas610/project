...
@section('konten')
    <form action="{{ route('profile.update') }}" method ="POST" enctype="multipart/form-data">
        @csrf
        <div class="row justif-content-betwwen">
            <div class="col5">
                <h3>Profile</h3>
                @if (get_meta_value('_foto'))
                <ing style="max-width:100px;max-height:100px" src="{{ asset('foto'."/".get_meta_value('_foto')) }}">
                    
                @endif
            <div class="mb-3">
                <label for="_foto" class="form-label">Foto</label>
                <input type="file" class="form-control form-control-sm" name="_foto" id="_foto"value="{{ get_meta_value('_email') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="_email" class="form-label">Foto</label>
            ...
            <div class="col5">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" name="_facebook" id="_facebook" value="{{ get_meta_value('_provinsi') }}">    
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="_github" class="form-label">Git Hub</label>
